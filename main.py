...
with open('detailed_info_product.csv', 'w', encoding='utf-8') as file:
...
for number_page in range(1, 65):
    ...
    for link in all_links_in_page:
        ...
        # with open('products/detail_info_product.html', 'w', encoding='utf-8') as file:
        #     file.write(response.text)
        #
        # # Открываем файл и читаем его содержимое
        # with open("products/detail_info_product.html", "r", encoding="utf-8") as file:
        #     content = file.read()
        ...
        json_data = json.loads(script_tag[4])
        ...
        for data_info in json_data['variants']:
            ...
            with open('detailed_info_product.csv', 'a', encoding='utf-8') as file:
                writer = csv.writer(file)
